...
## Clone this repo
```
git clone https://github.com/andrebtoe/mssqldocker.git
```

## From DockerHub
The latest image is available on DockerHub
```
https://hub.docker.com/r/andrebtoe/mssqldocker/
```
...
Pulling the image
```
docker-compose pull andrebtoe/mssqldocker
```
...
To do so, in your docker file start with `FROM andrebtoe/mssqldocker:latest`.
